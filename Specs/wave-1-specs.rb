...
describe "Scoring" do
  ...
  describe "self.highest_score_from(array_of_words)" do
    ...
    it "returns 7 letter word in case of tie involving a 7 letter word where smaller word is played after" do
      word_array = ["no", "zoo", "DANCERS", "ZQZZQQ", "dpple", "what"]
    ...
    it "returns 7 letter word in case of tie involving 7 letter word where smaller word was played first" do
      word_array = ["no", "zoo", "ZQZZQQ", "DANCERS", "dpple", "what"]
      Scrabble::Scoring.highest_score_from(word_array).must_equal "DANCERS"
    end
